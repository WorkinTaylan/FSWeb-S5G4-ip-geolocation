...
function ipInfo(ipObj) {
  ...
  ulke.textContent = "".concat(ipObj.ülke, " (").concat(ipObj.ülkeKodu, ")");
  ulke.classList.add("ulke");
  cardInfo.appendChild(ulke);
  var para1 = document.createElement("p");
  para1.textContent = "Enlem: ".concat(ipObj.enlem, " Boylam: ").concat(ipObj.boylam);
  cardInfo.appendChild(para1);
  var para2 = document.createElement("p");
  para2.textContent = "\u015Eehir: ".concat(ipObj.şehir);
  cardInfo.appendChild(para2);
  var para3 = document.createElement("p");
  para3.textContent = "Saat dilimi: ".concat(ipObj.saatdilimi);
  cardInfo.appendChild(para3);
  var para4 = document.createElement("p");
  para4.textContent = "Para birimi: ".concat(ipObj.parabirimi);
  cardInfo.appendChild(para4);
  var para5 = document.createElement("p");
  para5.textContent = "ISP: ".concat(ipObj.isp);
